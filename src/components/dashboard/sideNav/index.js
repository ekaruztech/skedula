        ...
        <Row>
          ...
          <div className="links--container w-100">
            <List
              ...
              iconOne={<i className="fas fa-briefcase"></i>}
              onClick={e => setOpen(prev => !prev)}
            />
            <Collapse isOpen={isOpen}>
              <div className="Dropdown w-100">
                {todos.length < 1 ? (
                  <div className="emptyTodo w-100">
                    <div className="display-5">
                      <strong>You do not have a todo yet</strong>
                    </div>
                    <div className="empty-btn">
                      <Button variant="primary" className="add-todo-side-nav">
                        Create todo
                      </Button>
                    </div>
                  </div>
            ...
            <List
              dropdown={false}
              text={"Pending"}
              iconOne={<i className="far fa-circle"></i>}
            />

            <List
              dropdown={false}
              text={"In Progress"}
              iconOne={<i className="fas fa-spinner"></i>}
            />
            <List
              dropdown={false}
              text={"Completed"}
              iconTwo={<i className="fa fa-chevron-down" />}
              iconOne={<i className="fas fa-check"></i>}
            />
          </div>
          <div className="logout-container w-100">
            <List
              dropdown={false}
              text={"Logout"}
              iconOne={<i className="fas fa-sign-out-alt"></i>}
            />
          </div>
        </Row>
      </Container>
